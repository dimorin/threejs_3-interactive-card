...
function init(){
  ...
  //const texture = textureLoader.load('https://images.unsplash.com/photo-1503480207415-fdddcc21d5fc?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8c2t5JTIwdGV4dHVyZXxlbnwwfHwwfHx8MA%3D%3D&w=1000&q=80');

  //scene.background = texture;//new THREE.Color(0xffaa00);
